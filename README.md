...
轻量级的前端模板工具库
  ...
  前端代码的高维护性，高阅读性和高拓展性的要求，view层的模板化需求越来越高，使可重复渲染利用的前端模板方法应运而生。但大部分框架体积较重，伴随着移动端的发展，轻量化高效的代码是前端工程追求的目标，就像jquery所说，write less do more。
pptpl就是一个前端模板的轻量级框架，只专注于模板的渲染，使模块化的代码和高效的性能相结合。
# 使用说明
  兼容：IE6+；<br />
